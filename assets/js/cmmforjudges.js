...
$(document).ready(function () {
    var table = $('#items_table').DataTable({
        "ajax": {
            "url": "../cmmforjudges/get_prresults",
            "data": function (d) {
        ...
        "columns": [
            ...
            },
            {
                ...
                render: function (data, type, row, meta) {
                    return '<a class="me-2 btn-sm editbtn rounded-0 py-0 edit_data" href="javascript:void(0)" data-id="' + (row.id) + '" data-url="../cmmforjudges/get_prresult_details/"><i class="ni ni-settings"></i></a>';
                }
            }
        ],
        "responsive": true,
...
$('#addItemForm').on('submit', function (e) {
    ...
    $('#items_table tbody').on('click', '.edit_data', function () {
        ...
        function edit_data(id) {
            ...
            $.ajax({
                url: "../cmmforjudges/get_prresult_details/" + id,
                type: "GET",
                dataType: "json",
                success: function (data) {
                    ...
                    if (data.prresult_details) {
                        ...
                        var existingSerial2 = data.prresult_details.serial2;
                        var existingUnique2 = data.prresult_details.unique2;
                        ...
                        $('#edit_serial2').val(existingSerial2);
                        $('#edit_unique2').val(existingUnique2);
...
unique2: $('#edit_unique2').val(),
serial2: $('#edit_serial2').val(),
...
$.ajax({
url: "../cmmforjudges/update_prresults",
type: "POST",
data: formData,
dataType: "json",
