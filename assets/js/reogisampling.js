...
$(document).ready(function () {
    ...
    function edit_data(id) {
        ...
        $.ajax({
            url: "../reogisampling/get_area_details/" + id,
            type: "GET",
            dataType: "json",
            success: function (data) {
                ...
                if (data.area_details) {
                    ...
                    tableHtml += '<th>Actual Quantity</th>'; // Add new header for difference
                    ...
                    areaDetails.forEach(function (item, index) {
                        var quantityDifference = item.quantity - item.quantity_lost; // Calculate difference
                        tableHtml += '<tr>';
                        ...
                        tableHtml += '<td>' + quantityDifference + '</td>'; // Display difference
    ...
    function updateStatus(statusUpdates) {
        $.ajax({
            url: "../reogisampling/update_status",
            type: "POST",
            dataType: "json",
