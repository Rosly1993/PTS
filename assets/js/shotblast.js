...
$(document).ready(function () {
    var table = $('#items_table').DataTable({
        "ajax": {
            "url": "../shotblastouts/get_prresults",
            "data": function (d) {
        ...
        "columns": [
            ...
            },
            {
                ...
                render: function (data, type, row, meta) {
                    return '<a class="me-2 btn-sm editbtn rounded-0 py-0 edit_data" href="javascript:void(0)" data-id="' + (row.id) + '" data-url="../shotblastouts/get_prresult_details/"><i class="ni ni-settings"></i></a>';
                }
            }
        ],
        "responsive": true,
...
function view_remarks(id) {
    ...
    $.ajax({
        ...
        function edit_data(id) {
            ...
            $.ajax({
                url: "../shotblastouts/get_prresult_details/" + id,
                type: "GET",
                dataType: "json",
                success: function (data) {
...
$.ajax({
url: "../shotblastouts/update_prresults",
type: "POST",
data: formData,
dataType: "json",
