...
$(document).ready(function () {
    var table = $('#items_table').DataTable({
        "ajax": {
            "url": "../ipqcforjudges/get_prresults",
            "data": function (d) {
        ...
        "columns": [
            ...
            },
            {
                ...
                render: function (data, type, row, meta) {
                    return '<a class="me-2 btn-sm editbtn rounded-0 py-0 edit_data" href="javascript:void(0)" data-id="' + (row.id) + '" data-url="../ipqcforjudges/get_prresult_details/"><i class="ni ni-settings"></i></a>';
                }
            }
        ],
        "responsive": true,
...
$('#addItemForm').on('submit', function (e) {
    ...
    $('#items_table tbody').on('click', '.edit_data', function () {
        ...
        function edit_data(id) {
            ...
            $.ajax({
                url: "../ipqcforjudges/get_prresult_details/" + id,
                type: "GET",
                dataType: "json",
...
$.ajax({
url: "../ipqcforjudges/update_prresults",
type: "POST",
data: formData,
dataType: "json",
