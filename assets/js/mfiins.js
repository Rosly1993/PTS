...
$(document).ready(function () {
    ...
    function addLot() {
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.status === 'success') {
                    ...
                    var disposition = quantityData.disposition;
                    ...
                    $('#dispositionDisplay').text('Diecast Status: ' + disposition);
                    ...
                    // hideModalFooter(); // Hide modal footer buttons based on disposition value
        ...
        $('#confirmAddLotBtn').off('click').on('click', function() {
            ...
            $.post("../mfiins/add_lot", { serial1: serial1, line: line })
                .done(function(data) {
