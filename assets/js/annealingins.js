...
$(document).ready(function () {
    ...
    function addLot() {
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.status === 'success') {
                    ...
                    $('#dispositionDisplay').text('QA Disposition: ' + disposition);
        ...
        $('#confirmAddLotBtn').off('click').on('click', function() {
            ...
            $.post("../annealingins/add_lot", { serial1: serial1, line: line })
                .done(function(data) {
