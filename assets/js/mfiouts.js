    ...
    var table = $('#items_table').DataTable({
        ...
        "columns": [
            ...
            },
            {
                ...
                render: function (data, type, row, meta) {
                    return '<a class="me-2 btn-sm editbtn rounded-0 py-0 edit_data" href="javascript:void(0)" data-id="' + (row.id) + '" data-url="../mfiouts/get_prresult_details/"><i class="ni ni-settings"></i></a>';
                }
            }
        ],
        "responsive": true,
...
$('#addItemForm').on('submit', function (e) {
    ...
    $('#items_table tbody').on('click', '.edit_data', function () {
        ...
        function edit_data(id) {
            ...
            $.ajax({
                url: "../mfiouts/get_prresult_details/" + id,
                type: "GET",
                dataType: "json",
