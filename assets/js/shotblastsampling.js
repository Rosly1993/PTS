...
$(document).ready(function () {
    ...
    var table = $('#items_table').DataTable({
        "ajax": "../shotblastsamplings/get_prresults",
        "columns": [
            {
                data: 'id',
            ...
            },
            {
                ...
                render: function (data, type, row, meta) {
                    return '<a class="me-2 btn-sm deletebtn rounded-0 py-0 edit_data" href="javascript:void(0)" data-id="' + (row.id) + '" data-url="../shotblastsamplings/get_prresult_details/"><i class="ni ni-fat-remove"></i></a>'+
...
function view_remarks(id) {
    ...
    $.ajax({
        ...
        function edit_data(id) {
            ...
            $.ajax({
            url: "../shotblastsamplings/update_prresults",
            type: "POST",
            data: formData,
            dataType: "json",
