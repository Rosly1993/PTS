...
class Lines_model extends CI_Model {
    ...
    public function get_lines_by_area($area_id) {
        // Modify your SQL query to include a WHERE clause to filter by area_id used in lot creation dropdown
    ...
    public function get_lines() {
        $this->db->select('set_lines.id, set_lines.lines,set_lines.created_by,set_lines.created_at, set_areas.area'); // Select desired columns
