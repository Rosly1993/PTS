<?php
class Reogisampling_model extends CI_Model {
	...
	public function get_areas() {
        ...
        $this->db->select('
            ...
            pr_result.cavity,
            pr_result.mfi_sorting_remarks,
            pr_result.mfi_serial
        ');

        $this->db->from('pr_result');
        $this->db->where('disposition', 'Sorted OK');
    ...
    public function get_area_details_by_control_number($control_number) {
        ...
        $query = $this->db->get_where('pr_result', ['mfi_serial' => $control_number, 'disposition' => 'Sorted OK']);
