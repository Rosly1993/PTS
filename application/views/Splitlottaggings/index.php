        ...
        <div class="header-body">
            <div class="row align-items-center py-4">
                <div class="col-lg-6 col-7">
                    <h6 class="h3 text-white d-inline-block mb-0">IPQE Split Lot Tagging</h3>
...
<?php $this->load->view("modals/splitlottaggings.php") ?>
<?php $this->load->view("modals/remarks.php") ?>
<?php $this->load->view('components/footer.php'); ?>      
<script src='<?=base_url()?>assets/js/splitlottaggings.js'></script>
