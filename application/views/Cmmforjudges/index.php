        ...
        <div class="header-body">
            <div class="row align-items-center py-4">
                <div class="col-lg-6 col-7">
                    <h6 class="h3 text-white d-inline-block mb-0">IPQE Dimension For Judge</h3>
    ...
    <div class="row">
        <div class="col">
            <div class="card">
                <!-- Card header -->
                <br>
            <div style="margin-left: 15px"><button class="btn btn-primary" ><a href="<?=site_url().'/cmmforjudges/'?>" style="color:white;text-decoration: none"> For Judge</a> </button>&nbsp;
                    ...
                    <table id='items_table' class="table table-bordered table-striped" style="width: 100%" >
                        <thead style="height: 50px">
                            <tr>
                                ...
                                <th scope="col">Date Scan-In</th>
                                <th scope="col">Date Scan-Out</th>
...
<?php $this->load->view("modals/cmmforjudges.php") ?>
<?php $this->load->view("modals/remarks.php") ?>
<?php $this->load->view('components/footer.php'); ?>      
<script src='<?=base_url()?>assets/js/cmmforjudges.js'></script>
