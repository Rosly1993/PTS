        ...
        <div class="header-body">
            <div class="row align-items-center py-4">
                <div class="col-lg-6 col-7">
                    <h6 class="h3 text-white d-inline-block mb-0">Oven Out</h3>
...
<div class="container-fluid mt--6">
    <div class="row">
        <div class="col">
            <div class="card"><br>
                <!-- Card header -->
            <div style="margin-left: 15px"><button class="btn btn-primary" ><a href="<?=site_url().'/ovenins/'?>" style="color:white;text-decoration: none"> Oven In</a> </button>&nbsp;
            <button class="btn btn-success"><a href="<?=site_url().'/ovenouts/'?>" style="color:white;text-decoration: none"> Oven Out</a></button></div>
            <form method="POST" action="">
                ...
                <option value="">Select Oven Machine...</option>
                    ...
                    <table id='items_table' class="table table-bordered table-striped" style="width: 100%" >
                        <thead style="height: 50px">
                            <tr>
                                ...
                                <th scope="col">Actual Baking(Mins)</th>
                                <th scope="col">Specs Bakinge(Mins)</th>
                                <th scope="col">Scan-in By</th>
                                <th scope="col">Machining IPQC</th>
                                <th scope="col">View Remarks</th>
                                <th scope="col">Diecast QA</th>
                                <!-- <th>Action</th> -->
                            </tr>
                        </thead>
                        <tbody>
                    ...
                    <div class="modal-dialog">
                        ...
                        <input type="hidden" class="form-control input-lg" id="userdata" name="userdata" value="<?php echo $fullname; ?>">
                            ...
                            <div class="form-group col-12 col-md-12 col-sm-12">
                                ...
                                <label for="locked_remarks" class="control-label">NG Remarks</label><span style="color:red">&nbsp;(Optional)</span>
...
<script src='<?=base_url()?>assets/js/ovenouts.js'></script> 
