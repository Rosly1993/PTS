        ...
        <div class="header-body">
            <div class="row align-items-center py-4">
                <div class="col-lg-6 col-7">
                    <h6 class="h3 text-white d-inline-block mb-0">Deburring Scan-out</h3>
    ...
    <div class="row">
        <div class="col">
            <div class="card">
                <!-- Card header -->
                <br>
            <div style="margin-left: 15px"><button class="btn btn-primary" ><a href="<?=site_url().'/deburringins/'?>" style="color:white;text-decoration: none"> Deburring In</a> </button>&nbsp;
            <button class="btn btn-success"><a href="<?=site_url().'/debouts/'?>" style="color:white;text-decoration: none"> Deburring Out</a></button></div>
                <!-- Card header -->
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        <label for="line" class="control-label">Deburring Line</label><span style="color:red">*</span>
                    ...
                    <label for="btn" class="control-label">Filter Line</label><span style="color:red">*</span><br>
                         <button type="submit" class="btn btn-success" style="width: 200px; height: 45px" id="FilterBtn">Scan In</button> 
                    </div>
                </div>
            </form>
                    ...
                    <table id='items_table' class="table table-bordered table-striped" style="width: 100%" >
                        <thead style="height: 50px">
                            <tr>
                                ...
                                <th scope="col">Deburring Line</th>
...
<?php $this->load->view("modals/edit_debout.php") ?>
<?php $this->load->view('modals/remarks.php'); ?>
<?php $this->load->view('components/footer.php'); ?>      
<script src='<?=base_url()?>assets/js/debouts.js'></script>
