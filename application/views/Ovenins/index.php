        ...
        <div class="header-body">
            <div class="row align-items-center py-4">
                <div class="col-lg-6 col-7">
                    <h6 class="h3 text-white d-inline-block mb-0">Oven Scan-in</h3>
...
<div class="container-fluid mt--6">
        ...
        <div class="col">
            ...
            <button class="btn btn-success"><a href="<?=site_url().'/ovenouts/'?>" style="color:white;text-decoration: none"> Oven Out</a></button>&nbsp;
...
<script src='<?=base_url()?>assets/js/ovenins.js'></script>
