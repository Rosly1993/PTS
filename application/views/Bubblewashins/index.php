        ...
        <div class="header-body">
            <div class="row align-items-center py-4">
                <div class="col-lg-6 col-7">
                    <h6 class="h3 text-white d-inline-block mb-0">Bubblewash Scan-in</h3>
...
<div class="container-fluid mt--6">
        ...
        <div class="col">
            ...
            <button class="btn btn-success"><a href="<?=site_url().'/bubblewashouts/'?>" style="color:white;text-decoration: none"> Bubblewash Out</a></button>&nbsp;
...
<?php $this->load->view('modals/bubblewash_in.php'); ?>
<?php $this->load->view('modals/remarks.php'); ?>
<?php $this->load->view('components/footer.php'); ?>
<script src='<?=base_url()?>assets/js/bubblewashins.js'></script>
