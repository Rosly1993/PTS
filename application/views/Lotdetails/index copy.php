        ...
        <script>
            $(document).ready(function () {
                ...
                var table = $('#items_table').DataTable({
                    "ajax": "<?php echo base_url('index.php/lotdetails/get_lotdetails'); ?>",
                    "columns": [
                        {
                            data: 'id',
                ...
                $.post("<?php echo base_url('index.php/molddetails/add_molddetails'); ?>", { model: modelName, mold_no: moldName, cavity_no: cavity_no, cavity1: cavity1Name, cavity2: cavity2Name, cavity3: cavity3Name, cavity4: cavity4Name, userdata: userdata })
                    .done(function (data) {
