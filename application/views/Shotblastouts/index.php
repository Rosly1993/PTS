        ...
        <div class="header-body">
            <div class="row align-items-center py-4">
                <div class="col-lg-6 col-7">
                    <h6 class="h3 text-white d-inline-block mb-0">Shotblast Scan-out</h3>
            ...
            <button class="btn btn-success"><a href="<?=site_url().'/shotblastouts/'?>" style="color:white;text-decoration: none"> Shotblast Out</a></button></div>
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        <label for="line" class="control-label">Shotblast Line</label><span style="color:red">*</span>
...
<?php $this->load->view("modals/shotblastout.php") ?>
<?php $this->load->view('modals/remarks.php'); ?>
<?php $this->load->view('components/footer.php'); ?>      
<script src='<?=base_url()?>assets/js/shotblast.js'></script>
