        ...
        <div class="header-body">
            <div class="row align-items-center py-4">
                <div class="col-lg-6 col-7">
                    <h6 class="h3 text-white d-inline-block mb-0">MAchining MRS DRY Confirmation</h3>
    ...
    <div class="row">
        <div class="col">
            <div class="card">
                <!-- Card header -->
                <br>
            <div style="margin-left: 15px"><button class="btn btn-primary" ><a href="<?=site_url().'/machiningmrs_wet/'?>" style="color:white;text-decoration: none"> Machining MRS Wet</a> </button>&nbsp;
            <button class="btn btn-success"><a href="<?=site_url().'/machiningmrs_dry/'?>" style="color:white;text-decoration: none"> Machining MRS Dry</a></button>&nbsp;
            <button class="btn btn-warning"><a href="<?=site_url().'/machiningmrs_dryconf/'?>" style="color:white;text-decoration: none"> Machining MRS Dry Confirmation</a></button>&nbsp;
...
<?php $this->load->view("modals/machiningmrs_dryconf") ?>
<?php $this->load->view("modals/remarks") ?>
<?php $this->load->view('components/footer.php'); ?>      
<script src='<?=base_url()?>assets/js/machiningmrs_dryconf.js'></script>
