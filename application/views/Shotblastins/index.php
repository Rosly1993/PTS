        ...
        <div class="header-body">
            <div class="row align-items-center py-4">
                <div class="col-lg-6 col-7">
                    <h6 class="h3 text-white d-inline-block mb-0">Shotblast Scan-in</h3>
...
<div class="container-fluid mt--6">
        ...
        <div class="col">
            <div class="card">
                <!-- Card header -->
                <br>
            <div style="margin-left: 15px"><button class="btn btn-primary" ><a href="<?=site_url().'/shotblastins/'?>" style="color:white;text-decoration: none"> Shotblast In</a> </button>&nbsp;
            <button class="btn btn-success"><a href="<?=site_url().'/shotblastouts/'?>" style="color:white;text-decoration: none"> Shotblast Out</a></button></div>
                <!-- Card header -->
              ...
              <div style="padding: 15px">
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        <label for="line" class="control-label">Shotblast Machine</label><span style="color:red">*</span>
                        <select type="text" class="form-control input-lg" id="line" name="line" placeholder="Enter description Name Here" style="height: 50px" required autocomplete="off" onchange="toggleSerialInput()">
                            <option value="">Please Select Line First</option>
...
<?php $this->load->view('modals/shotblast_in.php'); ?>
<?php $this->load->view('modals/remarks.php'); ?>
<?php $this->load->view('components/footer.php'); ?>
<script src='<?=base_url()?>assets/js/shotblastins.js'></script>
