        ...
        <div class="header-body">
            <div class="row align-items-center py-4">
                <div class="col-lg-6 col-7">
                    <h6 class="h3 text-white d-inline-block mb-0">Shotblast Unlock Tables</h3>
                    ...
                    <table id='items_table' class="table table-bordered table-striped" style="width: 100%" >
                        <thead style="height: 50px">
                            <tr>
                                ...
                                <th scope="col">Locked Details</th>
...
<script src='<?=base_url()?>assets/js/shotblastunlock.js'></script>
