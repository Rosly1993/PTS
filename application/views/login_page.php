...
<head>
  ...
  <title>Parts Traceability System</title>
  <!-- Favicon -->
...
<body class="bg-default">
  ...
  <nav id="navbar-main" class="navbar navbar-horizontal navbar-transparent navbar-main navbar-expand-lg navbar-light">
    <div class="container">
      <a class="navbar-brand" href="#">
        <img src="<?php echo base_url('assets/img/brand/PTS_LOGO.png')?> "  style="width: 120px; height: 150px">
      </a>
  ...
  <div class="main-content">
    <!-- Header -->
    <div class="header color py-7 py-lg-8 pt-lg-9">
      <div class="container">
      ...
      <div class="row align-items-center justify-content-xl-between">
        ...
        <div class="col-xl-6">
          <ul class="nav nav-footer justify-content-center justify-content-xl-end">
            <li class="nav-item">
              <a href="#" style="color:white" >Production Development Center</a>
            </li>
            <!-- <li class="nav-item">
