        ...
        <div class="header-body">
            <div class="row align-items-center py-4">
                <div class="col-lg-6 col-7">
                    <h6 class="h3 text-white d-inline-block mb-0">Bubblewash Out</h3>
...
<div class="container-fluid mt--6">
    <div class="row">
        <div class="col">
            <div class="card"><br>
                <!-- Card header -->
            <div style="margin-left: 15px"><button class="btn btn-primary" ><a href="<?=site_url().'/bubblewashins/'?>" style="color:white;text-decoration: none"> Bubblewash In</a> </button>&nbsp;
            <button class="btn btn-success"><a href="<?=site_url().'/bubblewashouts/'?>" style="color:white;text-decoration: none"> Bubblewash Out</a></button></div>
...
<script src='<?=base_url()?>assets/js/bubblewashouts.js'></script> 
