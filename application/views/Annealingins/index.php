        ...
        <div class="header-body">
            <div class="row align-items-center py-4">
                <div class="col-lg-6 col-7">
                    <h6 class="h3 text-white d-inline-block mb-0">Annealing Scan-in</h3>
              ...
              <div style="padding: 15px">
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        <label for="line" class="control-label">Annealing Machine</label><span style="color:red">*</span>
                        <select type="text" class="form-control input-lg" id="line" name="line" placeholder="Enter description Name Here" style="height: 50px" required autocomplete="off" onchange="toggleSerialInput()">
                            <option value="">Please Select Oven First</option>
...
<?php $this->load->view('modals/annealing_in.php'); ?>
<?php $this->load->view('modals/remarks.php'); ?>
<?php $this->load->view('components/footer.php'); ?>
<script src='<?=base_url()?>assets/js/annealingins.js'></script>
