    ...
    <div class="modal-dialog  modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="edit_modal_label">Machining Scan Out</h5>
            ...
            <div class="modal-body">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        <label for="edit_sequence">Sequence</label>
                       <input type="text" class="form-control" id="edit_sequence" name="editSequence"  placeholder="Enter Sequence">
                    </div>
                    <div class="form-group col-md-6">
                    ...
                    <div class="form-group col-md-6">
                        <label for="quantitylost">Sample Quantity (QA Inline)</label>
                       <input type="number" class="form-control" id="quantitylost" name="quantitylost"  value="0" placeholder="Enter Line Number">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="quantitylost">New Serial</label>
                       <input type="number" class="form-control" id="new_serial" name="new_serial"   placeholder="Enter New Serial">
                    </div>
                    <div class="form-group col-md-6">
                            <label for="category" class="control-label">Remarks Category</label><span style="color:orange">&nbsp; &nbsp;(Optional)</span>
