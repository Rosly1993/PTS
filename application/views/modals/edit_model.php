        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <input type="hidden" class="form-control input-lg" id="userdata" name="userdata" value="<?php echo $fullname; ?>">
                    ...
                    <div class="form-group">
                        <label for="edit_annealing">Annealing Baking</label>
                        <input type="number" class="form-control" id="edit_annealing" name="editAnnealing" placeholder="Enter Line Number">
                    </div>
                    <div class="form-group">
                        <label for="edit_oven">Oven Baking</label>
                        <input type="number" class="form-control" id="edit_oven" name="editOven" placeholder="Enter Line Number">
                    </div>
