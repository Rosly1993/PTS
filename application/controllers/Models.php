...
class Models extends CI_Controller {
    ...
    public function add_model() {
        ...
        if ($this->input->is_ajax_request()) {
            ...
            $oven = strtoupper($this->input->post('ovenName'));
            $annealing = strtoupper($this->input->post('annealingName'));
            ...
            if ($existing_area) {
                ...
                $this->models_model->add_model($model,$annealing,$oven, $created_by);
        ...
        public function update_model() {
            ...
            $annealing = $this->input->post('annealing'); // Convert to uppercase
            $oven = $this->input->post('oven'); // Convert to uppercase
            ...
            if ($existing_data['model'] === $model && $existing_data['annealing_baking'] === $annealing && $existing_data['oven_baking'] === $oven) {
