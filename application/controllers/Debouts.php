...
class Debouts extends CI_Controller {
    public function __construct() {
        parent::__construct();
        $this->load->library('session');
        $this->load->helper('url'); // Load URL Helper
        $this->load->model('debouts_model');
    ...
    public function index(){
        ...
        if($this->session->userdata('user')){
            ...
            $data['prresults'] = $this->debouts_model->get_prresults();
            ...
            $data['lines'] = $this->lines_model->get_lines_by_area('2'); // Pass '2' as area_id
             ...
             if($area_id =='19' || $area_id =='2'){
                ...
                $this->load->view('Debouts/index', $data);
    ...
    public function get_prresults() {
        ...
        $data = $this->debouts_model->get_prresults($line);
        echo json_encode(['data' => $data]); // Wrap the data in 'data' key
    }
    public function get_prresult_details($id) {
        $prresult_details = $this->debouts_model->get_prresult_details($id);
