...
class Scraps extends CI_Controller {
    ...
    public function index(){
        ...
        if($this->session->userdata('user')){
            ...
            $data['prresults'] = $this->scraps_model->get_prresults();
            $data['categories'] = $this->categories_model->get_categories();
            // Load the areas view with data
            $this->load->view('Scraps/index', $data);
        }
        else{
    ...
    public function get_prresults() {
        $data = $this->scraps_model->get_prresults();
        echo json_encode(['data' => $data]); // Wrap the data in 'data' key
    }
    public function get_prresult_details($id) {
        $prresult_details = $this->scraps_model->get_prresult_details($id);
