...
class Machiningmrs_wet extends CI_Controller {
    public function __construct() {
        parent::__construct();
        $this->load->library('session');
        $this->load->helper('url'); // Load URL Helper
        $this->load->model('machiningmrs_wet_model');
    ...
    public function index(){
        ...
        if($this->session->userdata('user')){
            ...
            $data['prresults'] = $this->machiningmrs_wet_model->get_prresults();
            ...
            if($area_id =='19' || $area_id =='11'){

                $this->load->view('Machiningmrs_wet/index', $data);
    ...
    public function get_prresults() {
        ...
        $data = $this->machiningmrs_wet_model->get_prresults($line);
        echo json_encode(['data' => $data]); // Wrap the data in 'data' key
    }
    public function get_prresult_details($id) {
        $prresult_details = $this->machiningmrs_wet_model->get_prresult_details($id);
    ...
    public function update_prresults() {
        ...
        $this->db->update('pr_unique', $data_unique);
         ...
         $data_history = array(
            ...
            'mrs_wet_details' => 'Scrap',
            'mrs_wet_date' => $updated_at,
            'mrs_wet_pic' => $userdata,
        );
        ...
        $data = array(
            ...
            'sample_by' => $userdata,
            'mrswet_remarks' => 'Sorted OK - ' . $userdata,
            'sample_date' => $updated_at,
            'quantity_lost' => $new_quantity_lost,
            'disposition_ipqc' => 'For Confirm',
            'disposition' => 'For Confirm',
        ...
        $data_history = array(
            ...
            'mrs_wet_details' => 'Sorted OK - ' . $userdata,
            'mrs_wet_date' => $updated_at,
            'mrs_wet_pic' => $userdata,
        );
