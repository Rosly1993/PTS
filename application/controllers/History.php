...
class History extends CI_Controller {
    ...
    public function index(){
        ...
        if($this->session->userdata('user')){
            ...
            $data['prresults'] = $this->history_model->get_prresults();
    ...
    public function get_prresults() {
        ...
        $data = $this->history_model->get_prresults($serial);
        echo json_encode(['data' => $data]); // Wrap the data in 'data' key
    }
    public function get_prresult_details($id) {
        $prresult_details = $this->history_model->get_prresult_details($id);
