...
class Ogisampling extends CI_Controller {
    public function __construct() {
        parent::__construct();
        $this->load->library('session');
        $this->load->helper('url'); // Load URL Helper
        $this->load->model('ogisampling_model');
    ...
    public function index(){
        ...
        if($this->session->userdata('user')){
            ...
            $data['areas'] = $this->ogisampling_model->get_areas();
            ...
            if($area_id =='19' || $area_id =='9'){
                ...
                $this->load->view('Ogisampling/index', $data);
    ...
    public function update_status() {
        ...
        foreach ($status_updates as $update) {
            ...
            $this->ogisampling_model->update_status($id, $status, $remarks, $date_add, $fullname,$area_status,$lot_status, $serial1, $model, $cavity, $quantity,$mfi_serial, $quantity_lost);
       
       
        }

        // include_once(APPPATH . 'views/PDF/qr.php');
